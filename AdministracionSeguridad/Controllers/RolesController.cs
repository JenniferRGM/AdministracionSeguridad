using AdministracionSeguridad.ViewModels;
using System;
...
namespace AdministracionSeguridad.Controllers
{
    public class RolesController : Controller
    {
        ...
        public ActionResult PermisosPorRol()
        {
            var permisos = db.Roles_Permisos
        .Include(rp => rp.Menus) 
        .Select(rp => new RolesPermisosViewModel
        {
            NombreMenu = rp.Menus.NombreMenu,
            PermisoLectura = rp.PermisoLectura,
           PermisoEscritura = rp.PermisoEscritura,
           PermisoModificacion = rp.PermisoModificacion,
           PermisoEliminacion = rp.PermisoEliminacion
       }).ToList();
