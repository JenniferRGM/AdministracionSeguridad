...
namespace AdministracionSeguridad.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PermisoID,NombrePermiso")] Permisos permisos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PermisoID,NombrePermiso")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
